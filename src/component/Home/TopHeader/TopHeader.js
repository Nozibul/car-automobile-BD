...
const TopHeader = () => {
    return (
        ...
        <div className="col-lg-3 col-sm-6  ">
            <p className="text-center  mt-1 "><Link className="contact" to="/contact">needhelp@car.com</Link></p>
        </div>
        <div className="col-lg-3 col-sm-12 ">
          <p className="text-center mt-1">
           <FontAwesomeIcon icon={faPhone} /><Link className="contact" to="/contact">+0018888777</Link></p>
        ...
        <div className="col-lg-6 col-sm-12 ">
            ...
            <div className=" text-center  icon-body mt-2">
                    ...
                    <FontAwesomeIcon className="mx-2 fs-5 icon-body" icon={faGooglePlus} />
